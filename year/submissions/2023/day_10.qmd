...
format:
  html:
    ...
    code-fold: true
    code-tools:
      source: "https://github.com/Meghansaha/genuary_subs/tree/ee17c875f979a9647d1ecc697171d751b5e73198/year/submissions/2023/scripts/10_gen_music.R"
...
<center>[\< Prev: January 9th - Plants](day_09.qmd) \| [Next: January 11th - Suprematism\>](day_11.qmd)</center>

![](images/10.png){fig-alt="An image of the five guitar chords maps of the notes played in the Nirvana song, Pennyroyal Tea on a beige background. The lyrics to the song is randomly placed on the page at different positions and angles in a dark maroon font." fig-align="center"}
