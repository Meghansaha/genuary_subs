...
format:
  html:
    ...
    code-fold: true
    code-tools:
      source: "https://github.com/Meghansaha/genuary_subs/tree/ee17c875f979a9647d1ecc697171d751b5e73198/year/submissions/2023/scripts/11_suprematism.R"
...
<center>[\< Prev: January 10th - Generative Music](day_10.qmd) \| [Next: January 12th - Tessellation\>](day_12.qmd)</center>

![](images/11.png){fig-alt="An image of two black and white striped quarte circles in the bottom left and top right of the image. The background of the image is filled with thick, distroted red and black lines." fig-align="center"}
