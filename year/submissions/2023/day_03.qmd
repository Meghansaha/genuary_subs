...
format:
  html:
    ...
    code-fold: true
    code-tools:
      source: "https://github.com/Meghansaha/genuary_subs/tree/ee17c875f979a9647d1ecc697171d751b5e73198/year/submissions/2023/scripts/03_glitch_art.R"
...
<center>[\< Prev: January 2nd - Made in Ten Minutes](day_02.qmd) \| [Next: January 4th - Intersections \>](day_04.qmd)</center>

![](images/03.png){fig-alt="An icy looking planet in space. The image have a grid over it that appears to have some pixels that have glitched out." fig-align="center"}
